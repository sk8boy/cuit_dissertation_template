...
- 从版本库上下载
  ...
  可以从 [Github](https://github.com/sk8boy/cuit_dissertation_template) 和 [Gitee](https://gitee.com/tiejunwang/cuit_dissertation_template) 上免费获得该模版。直接访问下面的链接，可下载模板的最新版本。

  https://github.com/sk8boy/cuit_dissertation_template/releases/latest

  https://gitee.com/tiejunwang/cuit_dissertation_template/releases/latest
...
- 更新模板
  ...
  **注意：** 直接下载的论文模板文件，通常包含有版本信息，例如 “成都信息工程大学硕士学位论文模板 v1.4.2.dotm”。此时会检查选中的模板文件的版本，如无法从模板文件中发现任何版本信息，或者版本较低，则将弹出警告信息。
